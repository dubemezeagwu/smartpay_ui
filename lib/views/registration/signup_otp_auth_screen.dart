...
class SignupOTPAuthenticationScreen extends StatefulWidget {
  const SignupOTPAuthenticationScreen({Key? key}) : super(key: key);

  @override
  State<SignupOTPAuthenticationScreen> createState() => _SignupOTPAuthenticationScreenState();
}

class _SignupOTPAuthenticationScreenState extends State<SignupOTPAuthenticationScreen> {
